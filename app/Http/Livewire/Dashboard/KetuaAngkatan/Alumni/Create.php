...
class Create extends Component
{
    ...
    public function store()
    {
        ...
        $user = Auth()->user();
        $this->tahun = $user->tahun;
        $this->tahun_akademik = $this->tahun->id_tahun;
    ...
    public function getData()
    {
        $user = Auth()->user();
        $this->tahun = $user->tahun;
        $this->tahun_akademik = $this->tahun->tahun;
    }

    public function render()
    {
        $this->getData();
        return view('livewire.dashboard.ketua-angkatan.alumni.create');
    }
}
