        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    @if (!$admin)
                        <center>
                            <small class="text-secondary">Menghapus data ini juga akan menghapus
                                data login dan data pendaftaran siswa dengan nama <b>{{ strtoupper($nama) }}</b></small>
                        </center>
                    @endif
                </div>
                <div class="modal-footer d-flex justify-content-center">
                    <button id="closeModal" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button wire:click="destroy({{ $idDelete }})" class="btn btn-danger" style="width: 100px;">
