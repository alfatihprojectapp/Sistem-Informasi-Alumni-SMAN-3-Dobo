        ...
        <section class="content">
            <div class="container-fluid">
                ...
                @if ($showLivewireCreate)
                    @livewire('dashboard.jurusan.create')
                    <script>
                ...
                @if ($showLivewireUpdate)
                    @livewire('dashboard.jurusan.update', ['jurusan' => $getJurusan])
                    <script>
                        $(document).ready(function() {
                ...
                @if ($showLivewireDelete)
                    @livewire('dashboard.jurusan.delete', ['jurusan' => $getJurusan])
                    <script>
                        $(document).ready(function() {
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">Kode Jurusan</th>
                                        ...
                                        @foreach ($jurusan as $data)
                                            <tr>
                                                <td style="vertical-align: middle;text-align: center;">
                                                    {{ $loop->iteration }}</td>
                                                <td style="vertical-align: middle;">{{ $data->kode_jurusan }}</td>
                                                <td style="vertical-align: middle;">{{ ucwords($data->nama_jurusan) }}
                                                </td>
                                                <td style="vertical-align: middle;text-align: center;">
                                                    <button class="badge bg-success mb-1 border-0 py-2"
                                                        wire:click="edit({{ $data->id_jurusan }})"
                                                        ata-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Ubah">
                                                        <span wire:loading.remove
                                                            wire:target="edit({{ $data->id_jurusan }})">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </span>
                                                        <span wire:loading wire:target="edit({{ $data->id_jurusan }})"
                                                    ...
                                                    <button class="badge bg-danger mb-1 border-0 py-2"
                                                        wire:click="delete({{ $data->id_jurusan }})"
                                                        ata-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Hapus">
                                                        <span wire:loading.remove
                                                            wire:target="delete({{ $data->id_jurusan }})">
