<div>
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h5 class="m-0">{!! $icon !!} {{ $title_page }}
                            ...
                            <button wire:click="ExportExcel({{ $user->tahun->id_tahun }})" class="mt-1 badge bg-primary border-0  px-3 py-2 mt-1"
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                @if ($showLivewireCreate)
                    @livewire('dashboard.ketua-angkatan.alumni.create')
                    <script>
                ...
                @if ($showLivewireUpdate)
                    @livewire('dashboard.ketua-angkatan.alumni.update', ['alumni' => $getAlumni])
                    <script>
                        $(document).ready(function() {
                ...
                @if ($showLivewireDelete)
                    @livewire('dashboard.ketua-angkatan.alumni.delete', ['alumni' => $getAlumni])
                    <script>
                        $(document).ready(function() {
        ...
        <form action="/dashboard/alumni/{{ $user->tahun->id_tahun }}/import" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Modal import -->
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="importDataLabel"><i class="bi bi-download"></i>
                                Import data alumni {{ $user->tahun->tahun }}</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <p class="mt-3">
                                        <a href="/template-file-import/template-import-alumni-2.xlsx"
