<div>
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h5 class="m-0">{!! $icon !!} {{ $title_page }}
                            ...
                            <button wire:click="ExportExcel" class="mt-1 badge bg-primary border-0  px-3 py-2 mt-1"
                                style="font-size: 10pt;font-weight: normal;width: 130px;">
                                <span wire:loading.remove wire:target="ExportExcel"><i
                                        class="bi bi-upload text-light"></i> Export Data</span>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                @if ($showLivewireCreate)
                    @livewire('dashboard.daftar-ketua-angkatan.create')
                    <script>
                ...
                @if ($showLivewireUpdate)
                    @livewire('dashboard.daftar-ketua-angkatan.update', ['ketua' => $getKetua])
                    <script>
                        $(document).ready(function() {
                ...
                @if ($showLivewireDelete)
                    @livewire('dashboard.daftar-ketua-angkatan.delete', ['ketua' => $getKetua])
                    <script>
                        $(document).ready(function() {
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if ($ketua_angkatan->count())
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;">Ketua Angkatan</th>
                                    ...
                                    <tbody>
                                        @foreach ($ketua_angkatan as $data)
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;text-align: center;">
                                                    <button class="badge bg-success mb-1 border-0 py-2"
                                                        wire:click="edit({{ $data->id }})" ata-bs-toggle="tooltip"
                                                        data-bs-placement="bottom" title="Ubah">
                                                        <span wire:loading.remove
                                                            wire:target="edit({{ $data->id }})">
                                                            <i class="bi bi-pencil-square"></i>
                                                        </span>
                                                        <span wire:loading wire:target="edit({{ $data->id }})"
                            ...
                            <div class="d-flex justify-content-end">{{ $ketua_angkatan->links() }}</div>
                        @else
                            <hr>
        ...
        <form action="/dashboard/ketua-angkatan/import" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Modal import -->
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <p class="mt-3">
                                        <a href="/template-file-import/template-import-ketua-angkatan.xlsx"
